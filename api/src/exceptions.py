...
UserExists = HTTPException(
    status_code=status.HTTP_409_CONFLICT,
    detail="Such user exists."
)
PasswordsAreNotTheSameException = HTTPException(
    status_code=status.HTTP_400_BAD_REQUEST,
    detail="Password confirmation is unsuccessful."
)
WrongOldPasswordException = HTTPException(
    status_code=status.HTTP_400_BAD_REQUEST,
...
CodeIsNotValidException = HTTPException(
    status_code=status.HTTP_409_CONFLICT,
