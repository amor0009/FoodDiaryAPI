...
from src.services.user_service import delete_user, get_profile_picture, \
    upload_profile_picture, calculate_nutrients_basic, calculate_nutrients
...
async def calculate_nutrients_for_authenticated_users(
        ...
        current_user: User = Depends(get_current_user)):
    return await calculate_nutrients(user_data, current_user)
...
async def calculate_nutrients_for_all_users(
    ...
    return await calculate_nutrients_basic(user_data, current_user)
