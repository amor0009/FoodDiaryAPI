...
from api.src.schemas.user import UserRead, UserUpdate
from api.src.schemas.user_weight import UserWeightUpdate
from api.src.services.user_service import find_user_by_login_and_email, delete_user, update_user
