...
from api.src.schemas.product import ProductCreate, ProductAdd, ProductUpdate, ProductRead
from api.src.services.product_service import get_products, add_product, change_product_info_for_weight, add_product_to_meal, \
