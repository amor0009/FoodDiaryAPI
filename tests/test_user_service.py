...
from api.src.schemas.user import UserUpdate, UserCalculateNutrients
from api.src.services.user_service import delete_user, update_user, find_user_by_login_and_email, \
