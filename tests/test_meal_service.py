...
from api.src.schemas.meal import MealCreate, MealRead, MealUpdate
from api.src.schemas.product import ProductRead
from api.src.services.meal_service import add_meal, get_user_meals, get_user_meals_with_products_by_date, \
